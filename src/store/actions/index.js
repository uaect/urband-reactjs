...
export {addtocart,getfromcart,deletecart,placeOrder}  from './cart.js';
export {register,login,getaddress,addaddress,getemirates,getemirates1,deleteaddress,getorderedlist,edituser,getuser}  from './account.js';