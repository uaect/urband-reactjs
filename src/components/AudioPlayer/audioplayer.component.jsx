...
const style = {
  ...
  volume(currentVolume) {
    ...
    return {
      ...
      width: 0,
      height: 0,
      borderBottom: `${height * currentVolume}px solid #e01e36`,
...
class H5AudioPlayer extends Component {
  ...
  componentDidMount() {
    ...
    slider.addEventListener("drag", e => {
      ...
      if (dragX) {
        ...
        audio.currentTime =
          (audio.duration * dragLeft) / (this.bar.offsetWidth - 20) || 0;
    ...
    slider.addEventListener("dragend", e => {
      ...
      const audio = this.audio;
      audio.currentTime =
        (audio.duration * this.state.dragLeft) / (this.bar.offsetWidth - 20) ||
        0;
      audio.play();
  ...
  mouseDownProgressBar = e => {
    ...
    if (mousePageX) {
      ...
      audio.currentTime =
        (audio.duration * dragLeft) / (bar.offsetWidth - 20) || 0;
      this.updateDisplayTime(dragLeft);
    }
  };
  ...
  render() {
    ...
    return (
      <div className="header_player style-fullwidth">
        <div
        ...
        >
          <div
            ...
            className="flex player-container-fullwidth"
          >
            <audio
              src={src}
              controls={false}
